...
class UserLoginView(APIView):
    ...
    def post(self,request,format=None):
        ...
        return Response({"errors":"Password or Email is incorrect"},status=status.HTTP_400_BAD_REQUEST)
...
class ChangePasswordResetEmail(APIView):
    renderer_classes = [UserRenderer]
    def post(self,request,format=None):
        serializer =  ChangePasswordResetEmailSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
